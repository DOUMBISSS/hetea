      ...
      <div className='footer'>
          ...
          <div className="foot--content">
              ...
              <div className='address'>
                ...
                <p><i className="fa-solid fa-envelope"></i> info@hetea.ci</p>
                <p><i className="fa-solid fa-globe"></i> www.hetea.ci</p>
              </div>
              ...
              <div className='social--media'>
                <h4 className='footer__title'>Réseaux sociaux</h4>
                  ...
                  <Link className='footer--link' to='/'><p>  <i className="fa-brands fa-x-twitter"></i> Twitter </p></Link>
